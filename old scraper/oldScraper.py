...
for row in myresult:
    ...
    #mycursor.execute(querys.get_update_product_name(productName,rowPid))
    #print(querys.get_update_product_name(productName,rowPid))

    # comentado por pruebas
    mycursor.execute(querys.get_insert_historical(rowPid, valor))
    #print(querys.get_insert_historical(rowPid,valor))
