...
sqlHelper = SqlHelper()
myresult = sqlHelper.select_init()
...
for row in myresult:
    ...
    productScraped = ProductScraped(row[0], row[1], row[2], row[3], row[4], row[5], row[6], row[7])
    ...
    print(str(productScraped.valor) + "\t..........\t"+ productScraped.productName)
